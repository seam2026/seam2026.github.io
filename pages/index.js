    ...
    <div>
      ...
      <Layout>
        ...
        <section id='home' className="flex lg:hidden w-full h-dvh relative overflow-hidden flex-col justify-between">
          ...
          <div className="flex flex-col w-full text-gray-900 dark:text-white text-center h-auto px-8 z-10 pt-24 flex-grow transition-colors duration-300">
          ...
          <div className="mx-4 bg-light-surface/[0.01] dark:bg-dark-500/13 p-3 rounded-xl border border-deep-pink/10 dark:border-white/20 text-deep-pink dark:text-white text-center z-10 mb-20 pb-6 backdrop-blur-sm transition-all duration-300">
