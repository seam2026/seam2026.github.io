    ...
    <div>
      ...
      <Layout>
        ...
        <section id='home' className="flex lg:hidden w-full h-dvh relative overflow-hidden flex-col justify-between">
          ...
          <div className="absolute h-full w-full bg-dark-450/60 z-0"></div>
          
          <div className="flex flex-col w-full text-white text-center h-auto px-8 z-10 justify-center flex-grow">
          ...
          <div className="mx-4 bg-dark-500/13 p-6 rounded-xl border border-white/20 text-white text-center z-10 pb-20">
        ...
        <section id='home' className='hidden lg:grid h-screen'>
          <div className="bg-dark-500 py-14 lg:py-0 grid-cols-2 h-screen relative">
            ...
            <div className="flex flex-col text-white px-16 justify-center z-10 col-span-2 w-full h-full text-center flex justify-center">
            ...
            >
              <svg className="w-8 h-8 text-white animate-bounce" xmlns="www.w3.org" fill="none" viewBox="0 0 24 24" stroke="currentColor">
